                                    ...
                                    <table class="table table-striped text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Session</th>
                                                <th>Session</th>
                                                <th class="text-center">Objectif de session</th>
                                                <th class="text-center">Sujets</th>
                                                <th class="text-center">Mini-Projet</th>
                                                <th class="text-center">CC/EFM</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>39</td>
                                                <td class="text-center">
                                                    Maitrisez POO en PHP!
                                                </td>
                                                <td>
                                                    <p>- Introduction à POO</p> 
                                                    <p>- Encapsulation</p>
                                                    
                                                </td>
                                                <td>
                                                    Application de gestion de bibliothèque                                                </td>
                                                <td>
                                                    CC2 SAS
                                                </td>
                                                <td class="text-center">
